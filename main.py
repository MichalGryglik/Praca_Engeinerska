...
nit.pretty_print_rules(nit_rules, example1_config.inputs)
...
y_pred_sy_single_value = y_pred_sy_single[example1_config.outputs[0]][0]
...
y_true = data[example1_config.outputs[0]].to_numpy(dtype=float)
...
y_pred_wm_values = y_pred_wm[example1_config.outputs[0]]
...
y_pred_nit_values = y_pred_nit[example1_config.outputs[0]]
...
y_pred_sy_values = y_pred_sy[example1_config.outputs[0]]
...
test_y_true_dict = {example1_config.outputs[0]: test_y_true}
...
y_pred_wm_test_values = y_pred_wm_test[example1_config.outputs[0]]
...
y_pred_nit_test_values = y_pred_nit_test[example1_config.outputs[0]]
...
y_pred_sy_test_values = y_pred_sy_test[example1_config.outputs[0]]
